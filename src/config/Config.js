...
const CONFIG = {
  ...
  SPREADSHEETS: {
    ...
    NAMS_CRITERIA: "1O3DSgTbhphNVDXLmlGkEiyVejsL_l4fPsf2cJJpQpTo",
  ...
  PUSH_DATA_CONFIGS: {
    sourceSheets: {
      ...
      "Allergies": {
        ...
        targets: [
          {
            spreadsheetId: "1O3DSgTbhphNVDXLmlGkEiyVejsL_l4fPsf2cJJpQpTo",
            sheetName: "Allergies"
          }
        ]
      }
  ...
  SUCCESS_LINKS: [
    {
      ...
      url: "https://docs.google.com/spreadsheets/d/1gaGyH312ad85wpyfH6dGbyNiS4NddqH6NvzTG6RPGPA/edit?gid=524766497#gid=524766497"
    },
    {
      name: "NAMS 2024-25 Criteria Sheet",
      url: "https://docs.google.com/spreadsheets/d/1O3DSgTbhphNVDXLmlGkEiyVejsL_l4fPsf2cJJpQpTo/edit?gid=93840204#gid=93840204"
    },
    {
 ...
 */
const RANGES = {
  SCHEDULES_CLEAR: "A2:O",
  CONTACT_INFO_CLEAR: "A2:J",
  ENTRY_WITHDRAWAL_CLEAR: "A2:O",
  ALT_HS_ATTENDANCE: "A2:H",
